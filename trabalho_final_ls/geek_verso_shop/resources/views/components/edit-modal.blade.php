...
<div class="modal fade" id="deleteModal{{ $product->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('produtos.edit', ['produto' => $product]) }}" method="POST"
                                ...
                                <form action="{{ route('produtos.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="product_description" id="product_description" maxlength="255" rows="2"
                                            class="form-control bg-dark text-white border-secondary" placeholder="Máximo de 255 caracteres" required>{{ old('product_description') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="product_price" id="price"
                                                ...
                                                value="{{ old('product_price', '0.00') }}" min="0"
                                                step="0.01" required>
                                            <button type="button" class="btn btn-outline-light"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="range" class="form-range" min="0" max="5"
                                            step="0.1" name="product_rating" id="product_rating"
